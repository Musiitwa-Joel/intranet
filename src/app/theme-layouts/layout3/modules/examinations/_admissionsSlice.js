...
export const admissionsAppSlice = createSlice({
  ...
  reducers: {
    ...
    setTotalApplicants: (state, action) => {
      state.totalApplicants = action.payload;
    },
    setApplicantsCurrentPage: (state, action) => {
      state.applicantsCurrentPage = action.payload;
    },
    setTotalAdmittedStds: (state, action) => {
      state.totalAdmittedStds = action.payload;
    },
  ...
  selectors: {
    ...
    selectTotalApplicants: (state) => state.totalApplicants,
