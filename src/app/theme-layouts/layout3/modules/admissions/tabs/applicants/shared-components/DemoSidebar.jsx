...
import {
  loadApplicantForms,
  programSelected,
} from "../../../../../../../store/admissions/applicantsSlice";
...
const DemoSidebar = React.memo(({ refetch, isRefetching }) => {
  ...
  const selectedRow = useSelector(selectSelectedApplicantSummary);

  const _groupedData = groupByCampusTitle(applicantsSummary);
