...
import { DELETE_STUDENT_MARKS } from "../../../gql/mutations";
...
function UploadHistory() {
  ...
  const [deleteStdMks, { error: deleteErr, loading: deletingStdMks }] =
    useMutation(DELETE_STUDENT_MARKS, {
      refetchQueries: ["Load_results_history"],
    });
  ...
  }, [error, loadErr, loadHistErr, deleteErr]);
